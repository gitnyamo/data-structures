...
public class MapsDataStructureCollection {
    ...
    public static void diamondMaps() {
        ...
        System.out.println(diamondMap.get(new Person("Mark", 38)));// if you do not use hashcode, this will print null even though the name of that key exists...
        // Take note that toString() in pojo and hashcode in pojo classes is really important especially when working with collections coding... reduces amount of time used o code
